...
<main class="main">
	...
	<div class="container">
		<div class="cat">
			@php
				echo view('layouts/_filter')->with(['collections' => $collections,'type' => $type,'collections_id' => $collections_id->id])->render();
			@endphp
			<div class="cat__wrapper" data-count="{{$count_cymbals}}">
				{!! $cymbals !!}
			</div>
